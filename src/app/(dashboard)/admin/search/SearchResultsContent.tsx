...
/**
 * AETHER OS - Search Results Content
 * Pfad: src/app/(dashboard)/admin/search/SearchResultsContent.tsx
 *
 * Diese Client-Komponente übernimmt das Daten-Fetching und das Rendering
 * der Ergebnistabelle basierend auf den Suchparametern.
 */
        ...
        <div className="p-10 space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.3em] text-gray-500">
                    <Search size={12} />
                    <span>QUERY_STRING: "{query || 'NULL'}"</span>
